...
// 纹理旋转(rotatin) 45deg  Math.PI(180deg) 默认按照左下角的点开始旋转 
// doorColorTexture.rotation = Math.PI / 4
// 纹理重复(repeat) 2,3 x重复俩次,y重复三次
...
// 纹理显示算法与mipmap(显示每一个像素)   修改默认线性为接近最近的纹理值
doorColorTexture1.minFilter = THREE.NearestFilter;
// 过滤字段
doorColorTexture1.magFilter = THREE.NearestFilter;
// 返回默认线性
// doorColorTexture1.minFilter = THREE.LinearFilter;
// doorColorTexture1.magFilter = THREE.LinearFilter;

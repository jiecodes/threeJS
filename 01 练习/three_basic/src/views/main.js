...
// 阴影灯光 
// 1、材质要满足能够对光照有反应
// 2、设置宣染器开启阴影的计算 renderer.shadowMap.enabled = true;
...
scene.add( light );
// 创建一个小球   0.1半径   20,20经纬线
const smallBall = new THREE.Mesh( new THREE.SphereGeometry(0.1, 20, 20), 
...
// gui.add(pointLight, "angle") .min(0).max(Math.PI / 2).step(0.01);
